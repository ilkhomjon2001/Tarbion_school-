...
/**
 * Eʼlonlar boshqaruvi (ADM-12) — admin, rahbariyat va oʻquv boʻlimi
 * kabinetlarida BIR XIL ishlatiladigan umumiy komponent.
 *
 * «Butun maktab» auditoriyasi shu rollarga ochiq (server tekshiradi);
 * sinf/fan roʻyxati jadval bilan cheklanmagan. Yuborishdan oldin qabul qiluvchilar soni
